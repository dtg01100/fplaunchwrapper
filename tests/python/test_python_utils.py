...
class TestPythonUtils:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("com.example.Test-App_1.2.3", "test-app_1.2.3"),
            ("org.gimp.GIMP", "gimp"),
...
class TestSecurity:
    ...
    def test_path_traversal_prevention(self):
        ...
        for attack_path in attack_paths:
            result = canonicalize_path_no_resolve(attack_path)
            # Should not resolve to sensitive paths
