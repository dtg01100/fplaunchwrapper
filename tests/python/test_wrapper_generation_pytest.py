...
class TestWrapperGeneration:
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    @patch("subprocess.run")
    def test_collision_detection(self, mock_subprocess, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    def test_aggressive_security_attack_simulation(self, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    def test_environment_variable_loading(self, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    def test_pre_launch_script_execution(self, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    def test_preference_handling(self, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    @patch("subprocess.run")
    def test_tar_extraction_safety(self, mock_subprocess, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    @patch("subprocess.run")
    def test_system_command_detection(self, mock_subprocess, temp_env):
    ...
    @pytest.mark.skipif(not GENERATE_AVAILABLE, reason="WrapperGenerator not available")
    def test_additional_invalid_character_cases(self, temp_env):
        ...
        for app_id, expected_name in test_cases:
            try:
                result = generator.generate_wrapper(app_id)
                assert isinstance(result, bool)
            except Exception:
